...
export default function HomePage() {
  ...
  return (
    <main className="h-screen w-screen overflow-y-scroll snap-y snap-mandatory font-sans text-white">
      ...
      <section className="snap-start h-screen w-screen flex items-center justify-center relative" style={{ backgroundColor: "#D3D3D3" }}>
        {/* Radial background as a background, not a DOM element */}
        <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.2),transparent)] z-0" />

        {/* Centered mystery card image */}
        <motion.img
          src="/images/mystery-card.png"
          alt="mystery card"
          className="relative h-[60vh] w-auto z-10 drop-shadow-[0_0_60px_rgba(255,255,255,0.4)]"
        />
